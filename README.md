...
- **Dataset 1 (DJI Mini 2):** 5-class problem using triaxial accelerometer recordings from a DJI Mini 2 in indoor hover flight. Best result: **98.58% test accuracy** (batch size 128, window length 4096).
- **Dataset 2 (DronePropB):** 10-class problem from ground testing with three fault types at three severity levels. Best result: **68.67% test accuracy** (batch size 64, window length 2048).
